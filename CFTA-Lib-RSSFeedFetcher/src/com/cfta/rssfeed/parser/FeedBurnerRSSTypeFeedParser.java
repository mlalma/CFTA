...
public class FeedBurnerRSSTypeFeedParser {
    ...
    private RSSFeedResponse parseChannel(XMLNode rootNode) {
        ...
        XMLNode channel = XMLParserUtil.findNode(CHANNEL_NODE, rootNode.childNodes);
        XMLNode title = XMLParserUtil.findNode(TITLE_NODE, channel.childNodes);
        XMLNode description = XMLParserUtil.findNode(DESCRIPTION_NODE, channel.childNodes);
        ...
        List<XMLNode> items = XMLParserUtil.findNodes(ITEM_NODE, rootNode.childNodes);
