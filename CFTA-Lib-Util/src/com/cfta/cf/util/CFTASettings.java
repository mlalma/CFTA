...
public class CFTASettings {
    ...
    static public long getHTTPConnectTimeout() { return returnLong("httpConnectTimeout", DEFAULT_HTTP_CONNECT_TIMEOUT);  }
    static public long getHTTPTimeout() { return returnLong("httpTimeout", DEFAULT_HTTP_TIMEOUT);  }
    static public String getHTTPUserAgent() { return returnString("httpUserAgent", DEFAULT_HTTP_USER_AGENT); }        
    static public long getRSSFeedParseTimeout() { return returnLong("rssFeedParseTimeout", DEFAULT_RSS_PARSING_TIMEOUT); }
    static public boolean getDebug() { return returnBoolean("debug", DEFAULT_DEBUG); }
    
    static public String getTwitterOAuthConsumerKey() { return returnString ("twitterOauthConsumerKey", OAUTH_CONSUMER_KEY); }
    static public String getTwitterOAuthConsumerSecret() { return returnString ("twitterOauthConsumerSecret", OAUTH_CONSUMER_SECRET); }
    static public String getTwitterAccessToken() { return returnString ("twitterOauthAccessToken", OAUTH_ACCESS_TOKEN); }
    static public String getTwitterAccessSecret() { return returnString ("twitterOauthAccessSecret", OAUTH_ACCESS_SECRET); }

    static public String getLangDetectProfileDir() { return returnString("langDetectProfileDir", LANG_DETECT_PROF_DIRECTORY); } 
    static public String getStopwordListDir() { return returnString("stopwordListDir", STOPWORD_LIST_DIRECTORY); }
}
