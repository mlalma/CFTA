...
public class XtractTitleExtractorNoLayout {
    ...
    private static String printText(Node n) {
    ...
    private void findHeader(Node n) {
        ...
        if (text.length() > MIN_HEADER_LENGTH && text.length() < MAX_HEADER_LENGTH) {
            ...
            if (headers.isEmpty() || textScore > MIN_HEADER_LENGTH) {
                ...
                double styleScore;
                if (n.getNodeName().equalsIgnoreCase(H1_TAG)) {
                    styleScore = 8.0;
                } else if (n.getNodeName().equalsIgnoreCase(H2_TAG)) {
                    styleScore = 8.0;
                } else if (n.getNodeName().equalsIgnoreCase(H3_TAG)) {
                    styleScore = 8.0;
                } else if (n.getNodeName().equalsIgnoreCase(H4_TAG)) {
                    styleScore = 4.0;
                } else if (n.getNodeName().equalsIgnoreCase(H5_TAG)) {
                    styleScore = 4.0;
                } else if (n.getNodeName().equalsIgnoreCase(H6_TAG)) {
                    styleScore = 4.0;
                } else {
                    styleScore = 2.0;
                }
    ...
    private void removeNonVisibleElements(Node n) {
        try {
