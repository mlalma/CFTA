...
public class ParsedWebPage {
    ...
    private HtmlNode parseNodeData(org.w3c.dom.Node n, int level) throws Exception {
        HtmlNode node = new HtmlNode();
        node.nodeName = n.getNodeName().trim();
        node.text = "";

        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_VISIBILITY_ATTRIB) != null) { node.visibile = n.getAttributes().getNamedItem(FFUL_VISIBILITY_ATTRIB).getNodeValue().equalsIgnoreCase("visible"); }
        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_X_POS_ATTRIB) != null) { node.xPos = (int)Double.valueOf(n.getAttributes().getNamedItem(FFUL_X_POS_ATTRIB).getNodeValue()).doubleValue(); }       
        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_Y_POS_ATTRIB) != null) { node.yPos = (int)Double.valueOf(n.getAttributes().getNamedItem(FFUL_Y_POS_ATTRIB).getNodeValue()).doubleValue(); }
        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_WIDTH_ATTRIB) != null) { node.width = (int)Double.valueOf(n.getAttributes().getNamedItem(FFUL_WIDTH_ATTRIB).getNodeValue()).doubleValue(); }
        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_HEIGHT_ATTRIB) != null) { node.height = (int)Double.valueOf(n.getAttributes().getNamedItem(FFUL_HEIGHT_ATTRIB).getNodeValue()).doubleValue(); }
        ...
        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_DISPLAY_ATTRIB) != null) { node.display = n.getAttributes().getNamedItem(FFUL_DISPLAY_ATTRIB).getNodeValue().trim().toLowerCase(); } 
        ...
        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_HEADER_SECTION) != null) { node.isHeaderNode = n.getAttributes().getNamedItem(FFUL_HEADER_SECTION).getNodeValue().trim().equalsIgnoreCase("true"); }
        if (n.getAttributes() != null && n.getAttributes().getNamedItem(FFUL_TEXT_SECTION) != null) { node.isTextNode = n.getAttributes().getNamedItem(FFUL_TEXT_SECTION).getNodeValue().trim().equalsIgnoreCase("true"); }
    ...
    private void parseRecursivelyNode(HtmlNode body, NodeList n, int level) throws Exception {
