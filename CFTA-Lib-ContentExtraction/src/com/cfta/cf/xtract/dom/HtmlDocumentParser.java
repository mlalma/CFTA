...
public class HtmlDocumentParser {
    ...
    public boolean isImage(org.w3c.dom.Node n) {
        ...
        if (n.getNodeName() != null && n.getNodeName().equalsIgnoreCase(IMG_ATTRIB) &&
            ...
            try {
                ...
                validImage = d.getHeight() >= MIN_VALID_IMAGE_HEIGHT && d.getWidth() >= MIN_VALID_IMAGE_WIDTH;
    ...
    static boolean isVideo(org.w3c.dom.Node n) {
        ...
        } else return n.getNodeName() != null && n.getNodeName().trim().equalsIgnoreCase(VIDEO_NODE);
